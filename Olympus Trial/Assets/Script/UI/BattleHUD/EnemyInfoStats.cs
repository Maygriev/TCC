...
public class EnemyInfoStats : MonoBehaviour
{
    [SerializeField]
    private GameObject turnNumber, enemyPortrait, lpBar, hcBar, scBar;
    ...
    public void MakeInfo(Sprite portrait, int curLP, int maxLP, int curHC, int maxHC, int curSC) {
        ...
        enemyPortrait.GetComponent<Image>().sprite = portrait;
